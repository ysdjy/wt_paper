...
| Fig. 4a–c | `figures/fig4_ablation/AUTHORITATIVE_A1_A6.csv` (`PASS_WITH_CORRECTION`) | A1–A6; Acc, Macro-F1, M-F1, M-Rec, Smooth | `Split=test_C6` | high-is-good: Ai−A1; Smooth benefit: Smooth_A1−Smooth_Ai | 6 configurations evaluated on 304 C6 runs | newer dedicated Fig.4 audit overrides the old source; heatmap colors are column-normalized by maximum absolute delta; raw deltas printed in cells |
